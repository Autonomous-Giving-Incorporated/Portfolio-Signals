...
async function mountPlatformAdmin() {
  ...
  mountIrProvisioning(content.querySelector('#irProvisioningArea'), {
    supabase: activeClient, clients: data, messages: getRuntimeConfig().irProvisioningMessages
  });
}
