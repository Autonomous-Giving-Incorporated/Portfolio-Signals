...
|---|---|---|---|
| Portfolio-Signals | `main` `4c38323` includes synthetic v1 + auth-email hardening + merged [#52](https://github.com/Autonomous-Giving-Incorporated/Portfolio-Signals/pull/52) SPEC-026 P1 CODE_SHIPPED | None required for #52; live pointing still operator-owned; unlocked pot RMW left as pre-existing pilot-scale | #18, #19, #20, C3 sign-off, #52 live pointing, leadership queue |
