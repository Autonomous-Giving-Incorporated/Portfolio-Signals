...
|---|---|---|---|
| Portfolio-Signals | `main` `3e5194c` includes synthetic v1 + auth-email hardening + merged [#52](https://github.com/Autonomous-Giving-Incorporated/Portfolio-Signals/pull/52) `4c38323` SPEC-026 P1 + [#58](https://github.com/Autonomous-Giving-Incorporated/Portfolio-Signals/pull/58) Resend webhook evidence; this branch adds atomic `am_credit_pot` | Apply `am_credit_pot` on the operator-owned platform project; live pointing still operator-owned | #18, #19, #20, C3 sign-off, #52 live pointing, leadership queue |
