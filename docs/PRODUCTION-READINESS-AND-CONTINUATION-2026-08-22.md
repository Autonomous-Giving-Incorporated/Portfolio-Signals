...
|---|---|---|---|
| Portfolio-Signals | `main` `36091e2` includes synthetic v1 + auth-email hardening + merged [#52](https://github.com/Autonomous-Giving-Incorporated/Portfolio-Signals/pull/52) `4c38323` SPEC-026 P1 + [#58](https://github.com/Autonomous-Giving-Incorporated/Portfolio-Signals/pull/58) Resend webhook evidence + [#59](https://github.com/Autonomous-Giving-Incorporated/Portfolio-Signals/pull/59) atomic `am_credit_pot` | None required for #59 RPC; live pointing still operator-owned | #18, #19, #20, C3 sign-off, #52 live pointing, leadership queue |
...
| SPEC-026 P1 connectors | Merged [PR #52](https://github.com/Autonomous-Giving-Incorporated/Portfolio-Signals/pull/52) `4c38323` CODE_SHIPPED (Givebutter + Donorbox + CSV twin). Review findings remain fail-closed on main. Not live. Not READY. Pot credit is atomic `am_credit_pot` (merged [#59](https://github.com/Autonomous-Giving-Incorporated/Portfolio-Signals/pull/59) `36091e2`) | CODE_SHIPPED |
...
| Atomic pot credit (2026-08-23) | Squash-merged [#59](https://github.com/Autonomous-Giving-Incorporated/Portfolio-Signals/pull/59) `36091e2`. Platform apply OBSERVED on `utdioxwiskzatwoejgiu` as `20260823192249_am_credit_pot` (repo file `20260823180000_am_credit_pot.sql`). `am_credit_pot` exists; `anon`/`authenticated` execute false; `service_role` execute true. No synthetic `atomic-rmw` pot written. Not a live gift. Not READY | OBSERVED |
