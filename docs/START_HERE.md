...
| Role-aware Auth email | **P8 tenant-member + isolation-director send/click OBSERVED** 2026-08-22 (Mailosaur `qpbqeifu`). MFA, platform-admin template, and webhook delivery status still PENDING. |
