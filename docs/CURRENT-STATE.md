...
| Givebutter / Donorbox P1 webhooks (SPEC-026 v1.1.0) | CODE_SHIPPED in-repo (`POST /webhooks/givebutter`, `POST /webhooks/donorbox`); merged [PR #52](https://github.com/Autonomous-Giving-Incorporated/Portfolio-Signals/pull/52) `4c38323`; not live; not READY; operator-owned pointing — [GIFT-CONNECTORS.md](GIFT-CONNECTORS.md) |
