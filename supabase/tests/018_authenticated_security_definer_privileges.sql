...
declare
  ...
  v_expected constant text[] := array[
    ...
    'public.execute_ir_provisioning(p_client_id text, p_operation_id uuid)',
    'public.get_ir_workspace_scaffold(p_client_id text)',
    'public.initialize_ir_workspace(p_client_id text, p_operation_id uuid)',
    'public.open_ir_workspace(p_client_id text)',
    'public.get_ir_provisioning_request(p_client_id text)',
    ...
    'public.request_ir_provisioning(p_client_id text, p_idempotency_key uuid, p_rationale text)',
